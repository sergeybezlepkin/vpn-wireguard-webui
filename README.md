...
# Оглавление
  ...
  - [(Опционально) Редактируем переменные в файле compose.yml](#опционально-редактируем-переменные-в-файле-composeyml)
  - [Итоговый файл compose.yml](#итоговый-файл-composeyml)
...
- В переменной окружения `PORT=48999` и `WG_PORT` можно указать удобный для себя порт. Например, выберите свободный порт из диапазонов 48658—48999 или 49001—49150.
